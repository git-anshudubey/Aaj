...
function Signup() {
    ...
    return (
        <div className="flex items-center justify-center my-8">
            <div className={`mx-auto w-full max-w-lg bg-white rounded-2xl p-10 shadow-xl border border-slate-100`}>
                ...
                {error && <p className="text-red-600 mt-8 text-center bg-red-50 p-3 rounded-lg text-sm">{error}</p>}
